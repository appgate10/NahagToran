//
//  UploadAVAssetExportSession.h
//
// This file is part of the UploadAVAssetExportSession package.
//
...
@protocol UploadAVAssetExportSessionDelegate;


/**
 * An `UploadAVAssetExportSession` object transcodes the contents of an AVAsset source object to create an output
...
@interface UploadAVAssetExportSession : NSObject

@property (nonatomic, weak) id<UploadAVAssetExportSessionDelegate> delegate;
...
@protocol UploadAVAssetExportSessionDelegate <NSObject>

- (void)exportSession:(UploadAVAssetExportSession *)exportSession renderFrame:(CVPixelBufferRef)pixelBuffer withPresentationTime:(CMTime)presentationTime toBuffer:(CVPixelBufferRef)renderBuffer;
