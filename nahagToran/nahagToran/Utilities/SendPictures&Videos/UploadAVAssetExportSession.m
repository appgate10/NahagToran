...
#import "UploadAVAssetExportSession.h"

@interface UploadAVAssetExportSession ()
...
@implementation UploadAVAssetExportSession
{
    NSError *_error;
...
{
    return [UploadAVAssetExportSession.alloc initWithAsset:asset];
}
...
- (AVMutableVideoComposition *)buildDefaultVideoComposition
{
    ...
    //        }
    //
    //    	MainCompositionInst.frameDuration = CMTimeMake(1, trackFrameRate);
    //
    ...
    //        naturalSize.height = targetSize.height;
    //    }
    ...
    // center inside
    {
        ...
        if (naturalSize.width == naturalSize.height) {
            transform.tx = transform.tx + postWidth;
        }
    }
