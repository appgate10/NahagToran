...
@interface SignUpVC : UIViewController<UIGestureRecognizerDelegate> 
...
@property (strong, nonatomic) IBOutlet UIImageView *imgOr;
@property (strong, nonatomic) IBOutlet UILabel *lblManualRegistration;
