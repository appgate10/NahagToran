...
-(void)setAdjustFontSize:(BOOL)adjustFontSize{
    if (adjustFontSize)
    {
        ...
        self.titleLabel.font = [self.titleLabel.font fontWithSize:self.titleLabel.font.pointSize*(screenBounds.size.width/375)]; // 320 for iPhone 5(320x568) storyboard design
